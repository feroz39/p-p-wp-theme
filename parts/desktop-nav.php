...
<div class="items-center hidden space-x-12 transition-all duration-500 lg:flex ease group-hover/menu:text-brand group-[.menu-open]/header:text-brand <?php echo $dark ? ' text-white' : ' text-brand'; ?>">
