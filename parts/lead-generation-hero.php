...
<div>
	<section class="relative z-10 md:min-h-screen h-auto md:max-h-[1100px] md:h-[1000px] md:px-12 px-6 flex flex-col-reverse md:flex-col bg-brand/80 py-36 md:py-0">
		<div class="relative w-full h-full max-w-screen-xl mx-auto">
			...
			<div class="flex items-center h-full mt-10 md:pt-28 md:mt-0">
				<div class="right-0 w-full text-white rounded-lg md:absolute md:w-5/12 bg-brand">
	...
	<img 
		...
		decoding="async" 
		data-nimg="1" 
		class="absolute inset-0 -z-10 h-auto min-h-screen md:max-h-[1100px] md:h-[1000px] object-cover grayscale w-full" 
